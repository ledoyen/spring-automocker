...
import com.github.ledoyen.automocker.api.jms.JmsMessageBuilder;
...
public class JmsApplicationTest {
    ...
    @Autowired
    private JmsMockLocator jmsMockLocator;
    ...
    public void hardcore_missing_header_throws_an_exception_catched_by_error_handler() {
        ...
        jmsMockLocator.getJmsMock().sendText("hardcore-echo-service", "test message");
